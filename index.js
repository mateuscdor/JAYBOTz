...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285162778904@s.whatsapp.net`, {text: '♨︎𝒷ℴ𝓉 𝓉ℯ𝓁𝒶𝒽 𝒷ℯ𝓇𝒽𝒶𝓈𝒾𝓁 𝓉ℯ𝓇𝒽𝓊𝒷𝓊𝓃𝓰 𝒷𝒶𝓃𝓰 𝕁𝔸𝕐𝔹𝕆𝕋𝕫' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = '𝗵𝗮𝗹𝗹𝗼 𝗯𝗼𝘀 @user 👋 \n untuk sewa bot atau undang bot mohon hubung owner 𝕁𝔸𝕐𝔹𝕆𝕋𝕫\n 𝘀𝗲𝗹𝗮𝗺𝗮𝘁 𝗱𝗮𝘁𝗮𝗻𝗴 𝗱𝗶 𝗴𝗿𝘂𝗽 @subject 😅\n 𝗶𝘀𝗶 𝗱𝘂𝗹𝘂 🤗\n\n*Nama:*\n*Umur:*\n*Askot:*\n\n*Deskripsi Grup:*\n\n@desc️' 
