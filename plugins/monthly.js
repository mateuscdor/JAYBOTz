...
let handler = async (m, { isPrems }) => {
    let time = global.db.data.users[m.sender].lastmonthly + 86400000
  if (new Date - global.db.data.users[m.sender].lastmonthly < 86400000) throw `Anda sudah mengklaim, klaim bulanan ini\ntunggu selama ${msToTime(time - new Date())} lagi`
